...
#
# Note:
#   - `rdirichlet` and `ddirechlet` are taken directly from the gtools package.
#   - The packages is available on CRAN and hosted on github:
#       https://github.com/r-gregmisc/gtools
#   - The package itself is orphaned - placing `rdirichlet` and `ddirechlet`
#       here avoids the warning of having a dependency on an orphaned package.
#
# ------------------------------------------------------------------------------
